...
PHP_NEW_EXTENSION(sdo, sdo.cpp SDO_DAS_ChangeSummary.cpp  SDO_DAS_DataFactory.cpp  SDO_DAS_Setting.cpp  SDO_DataObject.cpp  SDO_List.cpp  SDO_Model_Type.cpp SDO_Model_Property.cpp SDO_Model_ReflectionDataObject.cpp SDO_Sequence.cpp  sdo_utils.cpp $sdo_lib_srcs, $ext_shared,,-I@ext_srcdir@)
