...
{
	Logger::log("DataFactoryImpl created\n");
...
DataFactoryImpl::~DataFactoryImpl()
{
	Logger::log("DataFactory destroyed\n");
...
{
	Logger::log("DataFactoryImpl copy constructor\n");
	isResolved = false;
	copyTypes(inmdg);
}
...
{
	Logger::log("DataFactoryImpl assignment operator\n");
	if (this != &inmdg)
	{
		copyTypes(inmdg);
	}
...
TypeList DataFactoryImpl::getTypes() const
{
	...
	Logger::log("DataFactory creates list of types\n");
	...
	Logger::log("DataFactoryImpl returns the list of types\n");
