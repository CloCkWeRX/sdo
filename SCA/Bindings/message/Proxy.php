...
require_once 'SCA/Bindings/message/SAM_Client.php';
require_once "SCA/Bindings/message/Mapper.php";
require_once 'SCA/Bindings/message/ServiceDescriptionGenerator.php';
