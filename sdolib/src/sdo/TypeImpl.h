...
private:
	friend class DASDataFactoryImpl;
    ...
    TypeImpl(const char* uri,const char* name, bool isSeq= false, bool isOp = false); 
    TypeImpl(const Type* base, const char* uri,const char* name, bool isSeq = false, bool isOp = false); 
