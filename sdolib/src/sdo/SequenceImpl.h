...
//  It represents an ordered arbitrary mixture of data values from more than one 
//  property of a {@link DataObject data object}.
///////////////////////////////////////////////////////////////////////////
	...
	class seq_item {
	   public:
		   seq_item(const Property* p, unsigned int i):
			 the_prop(p)
			{
				 //cout << "SEQ: new prop sequence item" << this << endl;
				 index = i;
				 text = 0;
			}
		   seq_item(const char* t)
		   {
			   //cout << "SEQ: new text sequence item:" << this << endl;
		   ...
		   ~seq_item()
		   {
				//cout << "SEQ: delete sequence item:" << this << endl;
				if (text) {
					//cout << "Deleting text " << text << endl;
					delete text;
				}
		   }
		   ...
		   {
			   //cout << "SEQ: copy sequence item:" << this << endl;
