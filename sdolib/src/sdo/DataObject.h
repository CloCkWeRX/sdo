...
class DataObject : public RefCountingObject
{
	...
	virtual SDO_API ChangeSummaryPtr getChangeSummary(const char* path) = 0;
    virtual SDO_API ChangeSummaryPtr getChangeSummary(unsigned int propIndex) = 0;
    virtual SDO_API ChangeSummaryPtr getChangeSummary(const Property& prop) = 0;
