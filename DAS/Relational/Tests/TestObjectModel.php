...
class TestObjectModel extends PHPUnit2_Framework_TestCase
{
	...
	public function testAppRootTypeNotInModel() {
		...
		try {
			...
			$references_model = new SDO_DAS_Relational_ContainmentReferencesModel('not-a-valid-reference-or-table',$SDO_references_metadata);
