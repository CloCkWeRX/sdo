...
class TestReferencesModel extends PHPUnit2_Framework_TestCase
{
	...
	public function testActiveTypesCorrectlyDetermined() {
		...
		$references_model = new SDO_DAS_Relational_ContainmentReferencesModel('company',$SDO_references_metadata);
		...
		$references_model = new SDO_DAS_Relational_ContainmentReferencesModel('department',$SDO_references_metadata);
		...
		$references_model = new SDO_DAS_Relational_ContainmentReferencesModel('employee',$SDO_references_metadata);
